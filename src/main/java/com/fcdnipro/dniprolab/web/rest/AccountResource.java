...
import com.fcdnipro.dniprolab.domain.PersistentToken;
import com.fcdnipro.dniprolab.domain.User;
import com.fcdnipro.dniprolab.repository.PersistentTokenRepository;
import com.fcdnipro.dniprolab.repository.UserRepository;
import com.fcdnipro.dniprolab.security.SecurityUtils;
import com.fcdnipro.dniprolab.service.MailService;
import com.fcdnipro.dniprolab.service.UserService;
import com.fcdnipro.dniprolab.web.rest.dto.KeyAndPasswordDTO;
import com.fcdnipro.dniprolab.web.rest.dto.UserDTO;
            ...
            .orElseGet(() -> userRepository.findOneByEmail(userDTO.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail().toLowerCase(),
                        userDTO.getTelNumber(), userDTO.getLangKey());
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(),
                    userDTO.getEmail(), userDTO.getTelNumber(), userDTO.getLangKey());
