package com.fcdnipro.dniprolab.config;

import com.fcdnipro.dniprolab.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.fcdnipro.dniprolab.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.fcdnipro.dniprolab.repository.search")
