...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "dniprolab@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "dniprolab API";

        private String description = "dniprolab API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "dniprolab";
